...
export const HATS = [
  { id: 'none', name: 'No Hat', cost: 0, default: true, shapes: () => [] },
  {
    ...
    shapes: (c: any) => [
      { type: 'path', d: 'M28 34 Q28 16 50 16 Q72 16 72 34 Z', fill: c.hat },
      { type: 'path', d: 'M70 34 Q86 34 86 30 Q78 28 71 30 Z', fill: c.hat, opacity: 0.85 },
    ],
  },
  {
    id: 'beanie', name: 'Beanie', cost: 60,
    shapes: (c: any) => [
      { type: 'path', d: 'M28 36 Q28 16 50 16 Q72 16 72 36 Z', fill: c.hat },
      { type: 'rect', x: 27, y: 34, width: 46, height: 6, rx: 3, fill: c.hat, opacity: 0.75 },
      { type: 'circle', cx: 50, cy: 13, r: 4, fill: c.hat, opacity: 0.9 },
    ],
  },
  {
    id: 'grad', name: 'Graduation Cap', cost: 150,
    shapes: (c: any) => [
      { type: 'path', d: 'M30 30 L50 22 L70 30 L50 38 Z', fill: '#1F2937' },
      { type: 'rect', x: 40, y: 30, width: 20, height: 7, fill: '#1F2937', opacity: 0.9 },
      { type: 'line', x1: 68, y1: 29, x2: 74, y2: 42, stroke: c.accent, strokeWidth: 2 },
      { type: 'circle', cx: 74, cy: 43, r: 2.6, fill: c.accent },
    ],
  },
  {
    id: 'crown', name: 'Crown', cost: 200,
    shapes: () => [
      { type: 'path', d: 'M32 30 L36 18 L43 26 L50 15 L57 26 L64 18 L68 30 Z', fill: '#FBBF24' },
      { type: 'rect', x: 32, y: 29, width: 36, height: 5, rx: 2, fill: '#D97706' },
    ],
  },
  {
    id: 'bucket', name: 'Bucket Hat', cost: 80,
    shapes: (c: any) => [
      { type: 'path', d: 'M32 32 Q32 18 50 18 Q68 18 68 32 Z', fill: c.hat },
      { type: 'ellipse', cx: 50, cy: 33, rx: 26, ry: 5, fill: c.hat, opacity: 0.85 },
    ],
  },
]
