...
// Updated 2026-06-24 per feedback report #7 — ~8 weeks out.
export const LAUNCH_DATE_STRING = '2026-08-19T00:00:00+10:00'
export const LAUNCH_DATE = new Date(LAUNCH_DATE_STRING)
export const LAUNCH_DATE_DISPLAY = '19 August 2026'
