...
import { columnMathFor } from './columnMath'
...
export function deriveVisual(question, grade) {
  ...
  // 0. If this is a clean column-arithmetic sum (e.g. "532 − 318"), the practice
  //    UI already draws the stacked ColumnMath worksheet for it. Don't ALSO
  //    derive an equation/add/takeaway visual — that produced two visuals for
  //    one question. Let ColumnMath own these; derive nothing here.
  if (columnMathFor(t, g)) return null
