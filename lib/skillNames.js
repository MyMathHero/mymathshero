...
export const SKILL_ID_MAP = {
  // ── PREP / FOUNDATION (grade 0) — VC Foundation: early number sense built
  // through concrete/visual experiences. Powers Junior Mode (Prep–3). Kept
  // deliberately small + concrete; no reading-heavy topics.
  m_0_count5:     { category: 'number_sense', name: 'Counting to 5' },
  m_0_count10:    { category: 'number_sense', name: 'Counting to 10' },
  m_0_subitise:   { category: 'number_sense', name: 'How Many? (Subitising)' },
  m_0_morefewer:  { category: 'number_sense', name: 'More and Fewer' },
  m_0_biggersmaller: { category: 'number_sense', name: 'Bigger and Smaller' },
  m_0_numbermatch: { category: 'number_sense', name: 'Matching Numbers' },
  m_0_addto5:     { category: 'addition', name: 'Adding to 5' },
  m_0_takeaway5:  { category: 'subtraction', name: 'Taking Away (within 5)' },
  m_0_shapes:     { category: 'geometry', name: 'Everyday Shapes' },
  m_0_patterns:   { category: 'patterns', name: 'Simple Patterns' },
  m_0_sorting:    { category: 'patterns', name: 'Sorting and Matching' },
  m_0_size:       { category: 'measurement', name: 'Big, Small, Long, Short' },
