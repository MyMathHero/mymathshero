...
// Junior VISUAL experience (worlds, big-button visual questions) = Prep–2 only.
// Grade 3 uses the Standard (Grade-4-style) UI but KEEPS voice narration — see
// NARRATE_MAX_GRADE below.
export const JUNIOR_MODE_MAX_GRADE = 2
export const JUNIOR_DIAGNOSTIC_MAX_GRADE = 2
export const JUNIOR_DIAGNOSTIC_LENGTH = 10
// Auto-read questions aloud for Prep–Grade 3 (so Grade 3, now on the Standard UI,
// is still voice-guided). Grade 4+ is silent by default (tap to hear).
...
// Auto-narration on by default for Prep–Grade 3 (incl. Grade 3 on the Standard
// UI). Optional from Grade 4.
